...
INSERT INTO "new_Transaction" ("bankAccountId", "clientId", "confirmedAt", "createdAt", "depositAddressId", "depositAddressText", "depositNetwork", "depositQr", "id", "inrAmount", "note", "orderApprovedAt", "paymentExpiresAt", "paymentSubmittedAt", "screenshot", "sellMethod", "status", "type", "usdtAmount", "walletId") SELECT "bankAccountId", "clientId", "confirmedAt", "createdAt", "depositAddressId", "depositAddressText", "depositNetwork", "depositQr", "id", "inrAmount", "note", "orderApprovedAt", "paymentExpiresAt", "paymentSubmittedAt", "screenshot", "sellMethod", "status", "type", "usdtAmount", "walletId" FROM "Transaction";
